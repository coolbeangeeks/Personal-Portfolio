    ...
    <section id='project'>
      ...
      <div className="container container__project">
        <article className='project__item'>
          ...
          <a href="https://github.com/coolbeangeeks/movie-box" className='btn btn-primary' target='_blank'>Live Demo</a>
        ...
        <article className='project__item'>
          ...
          <a href="https://bankist-bank.vercel.app/" className='btn btn-primary' target='_blank'>Live Demo</a>
        ...
        <article className='project__item'>
          ...
          <a href="https://connectify-f27ca.web.app/" className='btn btn-primary' target='_blank'>Live Demo</a>
        ...
        <article className='project__item'>
          ...
          <a href="https://coolbeangeeks.github.io/Shopping-Cart/" className='btn btn-primary' target='_blank'>Live Demo</a>
